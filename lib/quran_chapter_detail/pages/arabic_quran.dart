...
class _ArabicQuranState extends State<ArabicQuran> {
  ...
  void initState() {
    ...
    //     chapterNum: widget.checkIndex, language: 'Arabic');
  ...
  void dispose() {
    ...
    super.dispose();
    // Future.delayed(Duration.zero,() => surahAyaahController.isLoading.value = false);
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snaphShot) {
        return snaphShot.connectionState == ConnectionState.waiting ? const Center(child: CircularProgressIndicator.adaptive(),) : Obx(() => ScrollablePositionedList.separated(
                ...
                itemCount: surahAyaahController.surahAyaahListAr.isEmpty
                    ? 0
                    : surahAyaahController.surahAyaahListAr.length,
                itemBuilder: (context, index) {
                  return SurahTileWidget(surahList: surahAyaahController.surahAyaahListAr[index], index: index, surahAyaahController: surahAyaahController, ctab: CTab.ar,);
                }));
      }
    );
  }
